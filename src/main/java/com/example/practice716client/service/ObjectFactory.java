 ...
 * generated in the com.example.practice716client.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetAllProducts_QNAME = new QName("http://service.practice716service.example.com/", "getAllProducts");
    private final static QName _SellProduct_QNAME = new QName("http://service.practice716service.example.com/", "sellProduct");
    private final static QName _AddProduct_QNAME = new QName("http://service.practice716service.example.com/", "addProduct");
    private final static QName _SellProductResponse_QNAME = new QName("http://service.practice716service.example.com/", "sellProductResponse");
    private final static QName _AddProductResponse_QNAME = new QName("http://service.practice716service.example.com/", "addProductResponse");
    private final static QName _GetAllProductsResponse_QNAME = new QName("http://service.practice716service.example.com/", "getAllProductsResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.example.practice716client.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.practice716service.example.com/", name = "getAllProducts")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.practice716service.example.com/", name = "sellProduct")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.practice716service.example.com/", name = "addProduct")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.practice716service.example.com/", name = "sellProductResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.practice716service.example.com/", name = "addProductResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.practice716service.example.com/", name = "getAllProductsResponse")
