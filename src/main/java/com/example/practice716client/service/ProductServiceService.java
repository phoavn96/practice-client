 ...
 * 
 */
@WebServiceClient(name = "ProductServiceService", targetNamespace = "http://service.practice716service.example.com/", wsdlLocation = "http://localhost:8088/ws/product?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTSERVICESERVICE_QNAME = new QName("http://service.practice716service.example.com/", "ProductServiceService");
    ...
    public ProductService getProductServicePort() {
        return super.getPort(new QName("http://service.practice716service.example.com/", "ProductServicePort"), ProductService.class);
    }
    ...
    public ProductService getProductServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.practice716service.example.com/", "ProductServicePort"), ProductService.class, features);
    }
